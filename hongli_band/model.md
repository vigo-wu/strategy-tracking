...
**主题目录**：`hongli_band/`｜**版本**：v1.49｜**形态**：单仓骨架 / 分笔多仓｜**运行**：国金 QMT 终端模型（见 §5）  
...
| `DIVIDEND_TYPE` | `"follow"` | 行情复权跟随主图/公式「复权方式」（仅 config） |
