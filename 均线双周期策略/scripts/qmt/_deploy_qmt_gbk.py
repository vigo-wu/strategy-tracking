# coding: utf-8
"""将 qmt_terminal_ma_dual.py 部署为国金 QMT 模型交易用的 GBK 文件。

编辑 scripts/qmt/qmt_terminal_ma_dual.py 后运行本脚本。
"""
...
SRC = HERE / "qmt_terminal_ma_dual.py"
...
def main() -> None:
    ...
    for dest in TARGETS:
        try:
            ...
            print("SKIP", dest, e)
    print("OK: 打开国金 QMT -> 模型交易 -> 加载 MaDual / 均线双周期")
