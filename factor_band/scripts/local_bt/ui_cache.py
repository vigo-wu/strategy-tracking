...
GRID_KEYS: tuple[str, ...] = (
    ...
    "grid_score_w_res",
    "grid_score_w_gen",
    "grid_score_dd_cap_pct",
    "grid_score_factor_target",
    "grid_score_pf_cap",
    "grid_score_sharpe_target",
    "grid_score_n_trades_floor",
    "grid_score_n_trades_full",
)
...
ROBUST_KEYS: tuple[str, ...] = (
    ...
    "robust_score_w_res",
    "robust_score_w_gen",
    "robust_score_dd_cap_pct",
    "robust_score_factor_target",
    "robust_score_pf_cap",
    "robust_score_sharpe_target",
    "robust_score_n_trades_floor",
    "robust_score_n_trades_full",
    "robust_score_go_floor",
)
