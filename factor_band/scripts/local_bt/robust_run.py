...
用法（仓库根目录）::
  ...
  python factor_band/scripts/local_bt/robust_run.py --spec path/to/robust.json
  python factor_band/scripts/local_bt/robust_run.py --spec path/to/robust.json --summarize-only
"""
