...
HLBAND = Path(__file__).resolve().parent.parent / "qmt" / "fband"
...
class CatalogContractTests(unittest.TestCase):
    ...
    def test_load_ns_shared(self) -> None:
        from _deploy_qmt_gbk import _fband_ns
        from _fband_ns import load_fband_ns

        a = load_fband_ns()["RECIPE"]["factor_params"]
        self.assertEqual(a, _fband_ns()["RECIPE"]["factor_params"])
