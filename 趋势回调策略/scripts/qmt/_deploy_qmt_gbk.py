# coding: utf-8
"""将 qmt_terminal_trend_pb.py 部署为国金 QMT 模型交易用的 GBK 文件。

编辑 scripts/qmt/qmt_terminal_trend_pb.py 后运行本脚本。
"""
...
def main() -> None:
    ...
    for dest in TARGETS:
        try:
            ...
            print("SKIP", dest, e)
    print("OK: 打开国金 QMT -> 模型交易 -> 加载 TrendPB / 趋势回调")
    print("主图: 目标股票 | 周期=日线 | 部署后请重新编译")
